...
<meta name="google-site-verification" content="Sx7DClwrkz_sbo94k3eVctKfrVeLeiB5SrN4wqkU5zY" />
	...
	<body>
		...
		<img id="logo" src="img/logo.var1.png">
		
		<div id="container">
			<form action="http://schedulecomparinator.us5.list-manage1.com/subscribe/post?u=e368b1b1ec527c4fe57ecac19&amp;id=c5746142b2" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" id="signup" target="_blank" onsubmit="showSocRem();">
			...
			<div id="social">
				<p id="soc-reminder">Don't forget to share Schedule Comparinator 2012 with your friends! :D</p>
				<div class="fb-like" data-href="http://schedulecomparinator.com/" data-send="false" data-layout="button_count" data-width="80" data-show-faces="false" data-action="like" data-font="arial"></div>
